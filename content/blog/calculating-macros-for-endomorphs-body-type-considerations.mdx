---
title: "Calculating Macros for Endomorphs: Body Type Considerations"
description: "How to adjust macro ratios and carb timing for endomorphic body types that gain fat more easily."
